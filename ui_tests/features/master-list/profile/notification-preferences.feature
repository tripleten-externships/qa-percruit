...
Feature: Email notification preferences
  ...
  Scenario Outline: Enable a notification preference (auto-saves and persists)
    When the Admin enables Message Notifications, Task & Goal Notifications, & Resume Review Notifications
    Then the preference is saved automatically
    And the Notifications Disabled status panel for Message Notifications, Task & Goal Notifications, & Resume Review Notifications is not shown
  ...
  Scenario Outline: Disable a notification preference (shows disabled status, persists)
    Given Message Notifications, Task & Goal Notifications, & Resume Review Notifications is currently enabled
    When the Admin disables Message Notifications, Task & Goal Notifications, & Resume Review Notifications
    Then the preference is saved automatically
    And a Notifications Disabled status panel for Message Notifications, Task & Goal Notifications, & Resume Review Notifications is displayed with explanatory text
