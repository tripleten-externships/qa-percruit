...
Scenario: View existing activities
  When I add the title View existing activities to the log
...
Scenario: Selecting a Category on activities page
  When I add the title Selecting a Category on activities page to the log
...
Scenario: Selecting a Topic on activities page
  When I add the title Selecting a Topic on activities page to the log
...
Scenario: Selecting a Unit on activities page
  When I add the title Selecting a Unit on activities page to the log
...
Scenario: Adding an Activity
  When I add the title Adding an Activity to the log
...
Scenario: Updating an existing Activity
  When I add the title Updating an existing Activity to the log
...
Scenario: Deletion of an existing Activity
  When I add the title Deletion of an existing Activity to the log
...
Scenario: No units present
  When I add the title No units present to the log
