...
When('the admin creates a new assignment with a valid mentor and student selected', async function () {
    ...
    // Navigate to Mentor Assignments section
    await this.assignmentPage.goToAssignments();
    // Create a new mentor-student assignment
    await this.assignmentPage.assignStudentToMentor('eric.hibbard91+student@gmail.com', 'Eric Hibbard');
    
});

Then('the system confirms successful creation', function () {
